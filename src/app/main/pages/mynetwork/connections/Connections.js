...
import MyConnections from './ProfileHeader';
      ...
      content={
        <div>
          <motion.div initial={{ scale: 0 }} animate={{ scale: 1, transition: { delay: 0.1 } }}>
            <MyConnections profile={profile} relationships={relationships}/>
          </motion.div>
...
export default withReducer('profileDetail', reducer)(withRouter(Connections));
