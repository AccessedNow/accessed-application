...
import { setSelectedItem, updateCandidate, setSelectedMenu, openEditCandidateDialog, removeCandidate, toggleStarredCandidate, selectCandidates } from './store/candidatesSlice';
			...
			<CandidatesTable
				...
				onRowClick={(ev, row) => {
					if (row) {
						...
						history.push('/talent/candidates/' + row.original.id);
					}
				}}
			/>
		</FuseAnimate>
