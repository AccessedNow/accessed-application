...
import { toggleView, setCandidatesSearchText, openNewCandidateDialog } from './store/candidatesSlice';
...
function CandidatesHeader(props) {
	...
	const candidates = useSelector(({ candidatesApp }) => candidatesApp.candidates);
	...
	return (
		<div className="flex flex-1 items-center justify-between p-4 sm:p-24">
			...
			<div className="flex flex-1 items-center justify-end">
				<ButtonGroup>
					<Button onClick={ev => dispatch(toggleView())}
						variant="contained"
					...
					<Button
						...
						onClick={ev => dispatch(openNewCandidateDialog())}
					>
						{`Add Candidate`}
					</Button>
				</ButtonGroup>
