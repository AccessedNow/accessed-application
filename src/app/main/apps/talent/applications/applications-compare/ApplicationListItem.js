...
function ApplicationListItem(props) {
  ...
  return (
    <StyledListItem
      ...
      button
    >
      <div className="flex flex-1 flex-row justify-between relative px-8">
        <div className="flex items-start w-full px-5 py-8 relative overflow-hidden">
          ...
          <div className="flex flex-1 flex-col justify-center relative overflow-hidden px-8">
            ...
            <Typography color={props.candidate.hasApplied ? 'textSecondary' : 'inherit'}>
              {props.candidate.jobTitle}
            </Typography>
            <Typography color={props.candidate.hasApplied ? 'textSecondary' : 'inherit'}>{props.candidate.primaryAddress.city?props.candidate.primaryAddress.city + ' ' + props.candidate.primaryAddress.country:props.candidate.primaryAddress.country}</Typography>
          </div>
        </div>
