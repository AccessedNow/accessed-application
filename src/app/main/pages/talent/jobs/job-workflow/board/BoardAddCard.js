...
import {openAddCandidateDialog} from "../store/cardSlice";
...
function BoardAddCard(props) {
  ...
  function handleOpenCandidateDialog() {
    dispatch(openAddCandidateDialog());
  }
		...
		<div className="w-full border-t-1">
			{formOpen ? (
				...
				>
					...
					<span className="mx-8">Add Candidate</span>
				</Button>
			)}
		</div>
	);
