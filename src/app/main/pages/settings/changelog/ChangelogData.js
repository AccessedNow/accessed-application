...
const changelogData = [
      ...
      <div className="text-14 p-24 border-2 rounded-16 w-full max-w-lg mt-40 mb-24">
        <ul className="list-disc">
          ...
          <Typography component="li" className="leading-loose">
            You should migrate to ui v5 to get the benefits of bug fixes and a lot of
            improvements such as the new styling engine. Checkout ui migration guide at{' '}
    ...
    notes: (
      <>
        ...
        >
          ...
          <br />
          <b>With the changes, We've removed ~57 redux related files from the -react.</b>
        </Typography>
      </>
    ),
  },
  ...
  },
  {
    ...
    newChanges: [
      ...
      'ui updated to v4.9.5',
      'All dependency packages updated.',
      'performance improvements.',
      'input autofill backgroundColor changed to transparent.',
    ],
    fixedChanges: ['ChipSelect error highligting.'],
  },
  {
    version: '4.0.1',
    date: '2020-02-16',
  ...
  },
  {
    ...
    newChanges: [
      ...
      'Codebase improved.',
      'ui updated to v4.9.1',
      'All dependency packages updated.',
    ],
    fixedChanges: [
      'Mutation fixed on route settings.',
      'Circular Dependency issues.',
      'RTL Scrollbars issue solved.',
    ],
    breakingChanges: [
      <span>
      ...
      '@ directories re-structured (@/components > @/core etc.), top level imports removed from @/index, import paths updated.',
  ...
  },
  {
    ...
    newChanges: [
      ...
      '"redirect the logged-in user to a specific route depending on his role" title added into the Authorization Doc.',
    ],
    fixedChanges: [
  ...
  },
  {
    ...
    date: '2019-11-20',
    newChanges: [
      'ui updated to v4.6.1',
      'react updated to v16.12.0',
      'All dependency packages updated.',
    ],
    fixedChanges: ['Page layout components: Drawer closes whenever click on it.'],
  },
  {
    version: '3.2.4',
    date: '2019-10-24',
    newChanges: [
      'ui updated to v4.5.1',
      'react updated to 16.11.0',
      'All dependency packages updated.',
      'Fake-db delay option added for testing purposes (src/@fake-db/mock.js).',
      'E-Commerce App, shows Loading component while product data is loading.',
      'Contacts App Contact Dialog Mobile refinement for scroll.',
      'Calendar App Native date input changed with DateTimePicker.',
      'Navigation, dense attr added for densed variation.',
    ],
    fixedChanges: [
      'NavbarMobileToggleFab Button added for to display absence of the toolbar.',
      <span>
        react-select returns null despite of empty array, workaround applied for ChipSelect.
        <a
  ...
  },
  {
    ...
    date: '2019-09-09',
    newChanges: [
      'ui updated to v4.4.1',
      'react updated to 16.9.0',
      'All dependency packages updated.',
      'ChipSelectFormsy Component added.',
      'Default Suspense loading delay changed to 0.',
    ],
    fixedChanges: [
      'HorizontalNav items minor theming issues.',
  ...
  },
  {
    ...
    newChanges: [
      ...
      'scrollToTopOnRouteChange added to Scrollbars.',
      <span>
    ...
    fixedChanges: [
      'scrollToTopOnChildChange changed with scrollToTopOnRouteChange in PageCarded.',
  ...
  },
  {
    ...
    fixedChanges: [
      'Layout do not hold render until settings at the redux state is updated. This causes multiple mount of the route component which has different layout settings.',
      'Layout style issues due to browser updates.',
      'Removal of event listeners in Scrollbars (@stephankaag).',
    ],
  },
  {
    version: '3.2.0',
  ...
  },
  {
    ...
    fixedChanges: [
      ' vertical navigation collapse items don’t have to be collapsed whenever navigation updated or location path changed.',
    ],
    breakingChanges: [
      'src/styles/-helpers.css renamed with src/styles/tailwind.css',
      'src/styles/-helpers.tailwind.css renamed with src/styles/tailwind.base.css',
    ],
  },
  {
    version: '2.2.2',
    ...
    fixedChanges: [
      ...
      'Theming issues (Countdown, tables of Invoice pages).',
    ],
  },
  {
    version: '2.2.1',
    date: '2019-02-11',
    newChanges: [
      'Dependency packages updated (react, ui etc).',
      'Navigation update,remove,append,prepend actions created, documentation page is updated.',
  ...
  },
  {
    ...
    newChanges: [
      ...
      "External Link Item added to Navigation (type:'link').",
  ...
  },
  {
    ...
    fixedChanges: [
      ...
      'Search did not hide auth protected navigation items.',
    ],
  },
  {
    version: '2.0.0',
    ...
    newChanges: [
      ...
      'SidePanel created and used in layout-3.',
      'Navigation: dense variant added for horizontal layout only.',
      'Shortcuts: vertical variant added.',
      'Search: basic variant added (checkout layout-3)',
    ...
    fixedChanges: [
      ...
      'Some IE fixes.',
      'Authorization must have state to prevent restricted route component mount when unauthorized user redirects.',
      "E-Commerce App, navigating product to new product didn't update the form state.",
      'Authentication timing issues fixed.',
    ],
    breakingChanges: [
      'Theme layouts moved out of the @ core files which gives developers to create or edit theme layouts easily.',
      'Project structure changed after new layout system.',
      'Theme configuration state moved from Theme to redux store (.settings).',
    ],
    notes: (
      <Typography
        className="text-14 p-12 border-2 rounded-16 w-full max-w-lg mt-16"
  ...
  },
  {
    ...
    newChanges: [
      'Academy App added.',
      'Search Component added (located at the main toolbar and searches in the navigation).',
      'ChipSelect documentation page added.',
      'Dependency packages updated (ui etc).',
    ],
    fixedChanges: [
      'Missing input variants added to Formsy Higher Order Components.',
      'ChipSelect variant styles fixed.',
      'NavHorizontalItem missing exact prop added.',
      "E-Commerce App, navigating product to new product didn't update the form state.",
      'Authentication timing issues fixed.',
    ],
  },
  {
    ...
    newChanges: [
      ...
      'Message variations added (error, success, alert, info).',
      'Dependency packages updated (ui etc).',
    ],
    fixedChanges: [
      'Message relocated (position changed absolute to fixed).',
  ...
  },
  {
    ...
    date: '2018-11-06',
    newChanges: [
      'Dialog Component added to theme layout for easily show dialog messages via redux action.',
      'Dependency packages updated (ui, react-redux etc).',
    ],
  ...
  },
  {
    version: '1.2.4',
    date: '2018-10-26',
    newChanges: ['Dependency packages updated (React, ui etc).'],
  },
  {
    version: '1.2.3',
    date: '2018-10-14',
  ...
  },
  {
    ...
    newChanges: [
      ...
      'Loadable component created for to avoid repetition.',
  ...
  },
  {
    ...
    newChanges: [
      ...
      'ChipSelect: "variant" attr added for to choose creatable or fixed multi selection.',
      'Dependency packages updated.',
  ...
  },
  {
    ...
    fixedChanges: [
      'Animate, AnimateGroup inject error.',
  ...
  },
  {
    ...
    newChanges: [
      <span>
        <code>velocity-react</code> added as dependency, its used for Animation
      </span>,
      <span>
        <code>Animation</code> <code>AnimationGroup</code> created for easily animate
  ...
  },
  {
    ...
    fixedChanges: [
      ...
      'Actions and reducers of  navigation fixed.',
    ],
    breakingChanges: [
      ...
      'Settings separated from the settings panel.',
    ],
  },
  {
    version: '1.0.5',
  ...
  },
  {
    ...
    newChanges: [
      ...
      'Message Component added to theme layout for easily show snackbar messages via redux action.',
    ],
    breakingChanges: [
      <span>
        <code>Auth</code> renamed with Authorization
      </span>,
