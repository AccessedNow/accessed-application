...
const cardSlice = createSlice({
    ...
    openAddCandidateDialog: (state, action) => {
      state.addCandidateDialogOpen = true;
      state.data = action.payload;
    },
    closeAddCandidateDialog: (state, action) => {
      state.addCandidateDialogOpen = false;
      state.data = null;
    }
	},
	extraReducers: {
...
export const { openCardDialog, closeCardDialog, openAddCandidateDialog,  closeAddCandidateDialog} = cardSlice.actions;
