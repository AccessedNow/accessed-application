...
function CompanyPage() {
  ...
  const company = useSelector(({ companyPage }) => {
    return companyPage.company
  });

  const peopleAlsoViewed = useSelector(({ companyPage }) => {
    return companyPage.peopleAlsoViewed;
  });
  ...
  useDeepCompareEffect(() => {
    dispatch(getCompany(routeParams));
        ...
        <div className="w-full">
          ...
          <div className="flex flex-col md:flex-row container">
              ...
              <div className="flex flex-col sm:flex sm:flex-row py-10">
                ...
                <div className="widget flex w-full sm:w-1/4 px-10">
                  ...
                  <div className="w-full pb-32">
                    <Followers id={routeParams.id} type={company.partyType}/>
                  </div>
                </div>

                <div className="widget w-full sm:w-3/4 sm:p-0 md:px-10 px-10">
                  {selectedTab === 0 && <TimelineTab />}
                  {selectedTab === 1 && <AboutTab company={company} />}
                  {selectedTab === 2 && <ReviewsTab />}
                  {selectedTab === 3 && <JobsTab company={company} />}
                  {selectedTab === 4 && <SalariesTab />}
                  {selectedTab === 5 && <PagesTab />}
                </div>
              </div>
            ...
            <div className="flex flex-col md:w-320 px-10">
              ...
              <div className="widget w-full pb-32">
                <LinkedPages id={routeParams.id} type={company.partyType}/>
              </div>
