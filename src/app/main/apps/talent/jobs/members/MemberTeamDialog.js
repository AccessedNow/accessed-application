...
import MemberTeamCardForm from './MemberTeamCardForm';
...
function MemberTeamDialog(props) {
	...
	return (
		...
		>
			<MemberTeamCardForm onAddMember={props.addMember} />
			

		</Dialog>
	);
}
export default withReducer('memberApp', reducer)(MemberTeamDialog);
