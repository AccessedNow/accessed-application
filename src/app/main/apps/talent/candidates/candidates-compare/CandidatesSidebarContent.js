...
import { openNewCandidateDialog, getCandidates, updateFilter, clearFilter } from './store/candidatesCompareSlice';
import {closeFilterSidebar} from './store/sidebarsSlice';
...
function CandidatesSidebarContent(props) {
  const user = useSelector(({ candidatesCompare }) => candidatesCompare.user);
  let filter = useSelector(({ candidatesCompare }) => candidatesCompare.candidates.filter);
  let address = useSelector(({ candidatesCompare }) => candidatesCompare.address);
  let skills = useSelector(({ candidatesCompare }) => candidatesCompare.skill);
  let industries = useSelector(({ candidatesCompare }) => candidatesCompare.industry);
