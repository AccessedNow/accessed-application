...
function JobAppSidebarContent(props) {
						...
						{filters.length > 0 &&
							filters.map(filter => (
								<ListItem
									button
									component={NavLinkAdapter}
									to={`/apps/job/filter/${filter.handle}`}
									activeClassName="active"
									className={classes.listItem}
									key={filter.id}
								>
						...
						{labels &&
							labels.map(label => (
								<ListItem
									button
									component={NavLinkAdapter}
									to={`/apps/job/label/${label.handle}`}
									key={label.id}
									className={classes.listItem}
								>
...
export default JobAppSidebarContent;
